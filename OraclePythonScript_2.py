...
dsn = st.text_input("Enter Oracle DSN", value="adb.ap-mumbai-1.oraclecloud.com")
host = st.text_input("Enter Oracle Host", value="adb.ap-mumbai-1.oraclecloud.com")
service_name = st.text_input("Enter Oracle Service Name", value="g10916f2e32ac91_dataentrega_high.adb.oraclecloud.com")
