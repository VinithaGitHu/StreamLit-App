...
# Connection string
connection_string = f"DRIVER={{ODBC Driver 17 for SQL Server}}; Server={server_name},1900;DATABASE={database_name};Trusted_Connection=yes;TrustServerCertificate=yes;"
