...
server_name = "192.168.29.74"
database_name = "DE_DWHM_DB"
table_name = "[dbo].[SampleTable]"

# Connection string
connection_string = f"DRIVER={{ODBC Driver 17 for SQL Server}}; Server={server_name},54869;DATABASE={database_name};Trusted_Connection=yes;TrustServerCertificate=yes;"
