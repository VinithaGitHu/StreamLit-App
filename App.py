...
# Connection string
connection_string = f"DRIVER={{ODBC Driver 17 for SQL Server}}; Server={server_name},{54868};DATABASE={database_name};Trusted_Connection=yes;TrustServerCertificate=yes;"
